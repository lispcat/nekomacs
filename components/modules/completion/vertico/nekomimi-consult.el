...
(mi/eval-now-and-after-load 'nekomimi-themes
  (mimi/leader-define-key
    "Tt" 'consult-theme))

(mi/eval-now-and-after-load 'nekomimi-buffers
  (mimi/leader-define-key
    "bb" 'consult-buffer))

(mi/eval-now-and-after-load 'nekomimi-dired
  (mimi/leader-define-key
